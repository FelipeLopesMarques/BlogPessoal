...
import com.generation.blogpessoal.servece.UsuarioService;
...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		// JSON que é inserido no Insomnia
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, 
			"Paulo Antunes", "paulo_antunes@email.com.br", "13465278", "https://i.imgur.com/JR7kUFU.jpg"));
		 
		// Configuração da Requisição (Edereço do endpoint, verbo , o corpo da requisição e a resposta esperada (Objeto da Classe Usuario Persistido no BD)
		ResponseEntity<Usuario> resposta = testRestTemplate
			.exchange("/usuarios/cadastrar", HttpMethod.POST, requisicao, Usuario.class);
		
		// Chacra se o Status code da Resposta foi CREATED -> 201
	...
	public void deveLogarUmUsuario() {
		usuarioService.cadastrarUsuario(new Usuario(0L,"Felipe Lopes Marques", "felipe@gmail.com.br","12341234", ""));
		HttpEntity<UsuarioLogin> requisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin
				(0L, "", "Felipe Lopes Marques", "felipe@gmail.com.br","12341234", ""));
